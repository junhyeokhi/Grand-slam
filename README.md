...
<div align="center">
  <img src="https://github.com/user-attachments/assets/08cebc3a-249d-40e9-b3c4-a1206991cb57" alt="프로젝트 시연 GIF" width="800">
</div>
...
|                                   메인 화면                                    |                               티켓 검색 및 필터링                                |
| :----------------------------------------------------------------------------: | :------------------------------------------------------------------------------: |
| <img src="https://github.com/user-attachments/assets/bbda83c4-0e3e-4e44-a824-efc68bb367d5" width="500"> | <img src="https://github.com/user-attachments/assets/2e3dccdb-43ee-4a5b-89dc-2f40b64f9773" width="500"> |
|                          **안전 결제 (토스페이먼츠)**                          |                          **마이페이지 (알림/장바구니)**                          |
|  <img src="https://github.com/user-attachments/assets/73dcb76e-6ff2-4bdd-b9b9-d00fe43fac76" width="500">  |   <img src="https://github.com/user-attachments/assets/007e744a-02d6-4676-a667-ddb3dbe5d81f" width="500">   |
...
```bash
git clone <https://github.com/Grand-slam-project/Grand-slam.git>
cd Grand-slam
...
```bash
flask db init      # 1. 마이그레이션 저장소 초기화 (폴더 생성)
flask db migrate   # 2. models.py를 읽어서 새로운 설계도 파일 생성
flask db upgrade   # 3. 생성된 설계도를 실제 DB에 적용
python seeddata.py # 테스트용 데이터 주입
```
